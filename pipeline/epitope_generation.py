...
class Variant2Epitope():
  def __init__(self, protein_path = 'Homo_sapiens.GRCh37.74.pep.all.fa', cdna_file='Homo_sapiens.GRCh37.74.cdna.all.fa', cds_path='Homo_sapiens.GRCh37.74.cds.all.fa'):
    if cdna_file:
